...
try {
  ...
  return (
    ...
    <h1  className='black'>Todos os projetos</h1>
    <div  className="projetos-content container">
        {destaques.map((projeto)=>(
            <div ref={projectsRef} key={projeto.id} data-aos="fade-left" className='projeto-section'>
                <div className="img-projetos">
                    <img src={projeto.pcimg1}  className="image-1" alt="" />
                    <img src={projeto.pcimg2}  className="image-2" alt="" />
                </div>
